...
static PyMethodDef __pyx_mdef_8pyrender_1render = {"render", (PyCFunction)__pyx_pw_8pyrender_1render, METH_VARARGS|METH_KEYWORDS, 0};
  ...
  __Pyx_RefNannySetupContext("render (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_cam_intr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("render", 1, 5, 5, 2); __PYX_ERR(0, 18, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_znf)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("render", 1, 5, 5, 3); __PYX_ERR(0, 18, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_img_size)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_vertices = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0]); if (unlikely(!__pyx_v_vertices.memview)) __PYX_ERR(0, 18, __pyx_L3_error)
    __pyx_v_faces = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[1]); if (unlikely(!__pyx_v_faces.memview)) __PYX_ERR(0, 18, __pyx_L3_error)
    __pyx_v_cam_intr = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[2]); if (unlikely(!__pyx_v_cam_intr.memview)) __PYX_ERR(0, 18, __pyx_L3_error)
    __pyx_v_znf = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[3]); if (unlikely(!__pyx_v_znf.memview)) __PYX_ERR(0, 18, __pyx_L3_error)
    __pyx_v_img_size = __Pyx_PyObject_to_MemoryviewSlice_dc_int(values[4]); if (unlikely(!__pyx_v_img_size.memview)) __PYX_ERR(0, 18, __pyx_L3_error)
  }
 ...
 */
  __pyx_t_16 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_16);
 ...
 */
  __pyx_t_21 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_float(__pyx_v_depth);
  if (unlikely(!__pyx_t_21.memview)) __PYX_ERR(0, 42, __pyx_L1_error)
 ...
 */
  __pyx_t_22 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_unsigned_char(__pyx_v_mask);
  if (unlikely(!__pyx_t_22.memview)) __PYX_ERR(0, 43, __pyx_L1_error)
 ...
 */
  __pyx_t_23 = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_unsigned_char(__pyx_v_img);
  if (unlikely(!__pyx_t_23.memview)) __PYX_ERR(0, 44, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_15);
  __pyx_t_14 = __Pyx_PyObject_GetAttrStr(__pyx_v_img, __pyx_n_s_transpose); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_14);
  __pyx_t_11 = __Pyx_PyObject_Call(__pyx_t_14, __pyx_tuple__6, NULL); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
  ...
  for (;;) {
    if (likely(!__pyx_t_4)) {
      ...
      if (unlikely(!__pyx_t_5)) {
        ...
        if (curexc_type) {
          if (likely(__Pyx_PyErr_GivenExceptionMatches(curexc_type, PyExc_StopIteration))) PyErr_Clear();
 ...
 */
  ...
  __pyx_tuple__6 = PyTuple_Pack(1, __pyx_tuple__5); if (unlikely(!__pyx_tuple__6)) __PYX_ERR(0, 51, __pyx_L1_error)
 ...
 *     raise Exception('vertices must be a 3xM double array')
 */
  __pyx_tuple__35 = PyTuple_Pack(23, __pyx_n_s_vertices, __pyx_n_s_faces, __pyx_n_s_cam_intr, __pyx_n_s_znf, __pyx_n_s_img_size, __pyx_n_s_VM, __pyx_n_s_vNum, __pyx_n_s_FM, __pyx_n_s_fNum, __pyx_n_s_intrinsics, __pyx_n_s_zNearVarV, __pyx_n_s_imgSize, __pyx_n_s_coloring, __pyx_n_s_CM, __pyx_n_s_depth, __pyx_n_s_mask, __pyx_n_s_img, __pyx_n_s_depth_view, __pyx_n_s_mask_view, __pyx_n_s_img_view, __pyx_n_s_depthBuffer, __pyx_n_s_maskBuffer, __pyx_n_s_imgBuffer); if (unlikely(!__pyx_tuple__35)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__35);
  __Pyx_GIVEREF(__pyx_tuple__35);
  __pyx_codeobj__36 = (PyObject*)__Pyx_PyCode_New(5, 0, 23, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__35, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pyrender_pyx, __pyx_n_s_render, 18, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__36)) __PYX_ERR(0, 18, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initpyrender(void); /*proto*/
PyMODINIT_FUNC initpyrender(void)
#else
PyMODINIT_FUNC PyInit_pyrender(void); /*proto*/
PyMODINIT_FUNC PyInit_pyrender(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_pyrender(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_pyrender(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyrender", 0, __pyx_lineno, __pyx_filename);
    }
